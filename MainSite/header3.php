<div id="navigation">
				    ...
				    <nav class="nav frist-top-nav">
						...
						<li><a href="index.php"><span class="bref-icon1"> </span>Dashboard</a></li>
				            <li><a href="barchart.php"><span class="qurter-icon1"> </span>stats</a></li>
				            <li   class="active"><a class="mess" href="messages.php"><span class="mess-icon1"> </span>Message<label>2</label></a></li>
